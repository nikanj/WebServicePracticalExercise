...
public class GuestBookDaoImpl implements GuestBookDao {
	...
	public List<GuestBook> retrieveGuestBook(GuestBook guestBook) {
		String sql = "select * from GUEST_BOOK where BOOK_ID = :guestBookId or AUTHOR_NAME = :name or GUEST_TITLE = :title or GUEST_TEXT = :text or GUEST_EMAIL_ID = :email";
	...
	public List<GuestBook> retrieveAllGuestBooks() {
		 ...
		 if(obj!=null){
			 	bookList = ((List<GuestBook>) obj);
			 	Iterator<GuestBook> listIt = bookList.iterator();
...
*/
	...
	public List<Keyword> retrieveGuestBookKeywords(String keywordLike) {
		...
		GuestBookHelper.removeDuplicateObjects(guestBookKeywordsList);
	    return guestBookKeywordsList;
	}
