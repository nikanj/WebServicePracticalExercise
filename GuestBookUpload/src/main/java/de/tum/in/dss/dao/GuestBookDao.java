...
public interface GuestBookDao {
	...
	int addGuestBookEntries(List<GuestBook> entries);
	...
	List<GuestBook> retrieveGuestBookListByKeywordsInText(
			List<String> keywordList);

	GuestBook retrieveGuestBookByGuestBookName(String guestBookName);
