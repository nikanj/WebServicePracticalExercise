...
public class GuestBookDaoImpl implements GuestBookDao {
	...
	public List<GuestBook> retrieveGuestBookListByKeywords(final List<String> keywordList) {
		...
		List<String> updatedkeywordList = retrieveGuestBookKeywords(keywordList);
		updatedkeywordList.addAll(keywordList);
		updatedkeywordList = GuestBookHelper.removeDuplicates(updatedkeywordList);
		List<GuestBook> guestBookList = new ArrayList<GuestBook>();
		
		if(keywordList!=null && keywordList.size()>0){
			Map<String, List<String>> params = Collections.singletonMap("keywords", updatedkeywordList);
