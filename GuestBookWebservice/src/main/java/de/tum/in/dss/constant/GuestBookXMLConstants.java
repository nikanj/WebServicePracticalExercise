...
public class GuestBookXMLConstants extends CommonConstants {
	...
	public static String GUEST_EMAIL_SUFFIX = "GUEST_EMAIL_ID";
	public static String GUEST_BOOK_DATE_OF_CREATION_SUFFIX = "DATE_OF_CREATION";
	public static String GUEST_BOOK_LAST_MODIFICATION_DATE_SUFFIX = "LAST_MODIFICATION_DATE";
	...
	public static final String GUEST_EMAIL = GUEST_BOOK_ELEMENT_PREFIX + ":" + GUEST_EMAIL_SUFFIX;
	public static final String GUEST_BOOK_DATE_OF_CREATION = GUEST_BOOK_ELEMENT_PREFIX + ":" + GUEST_BOOK_DATE_OF_CREATION_SUFFIX;
	public static final String GUEST_BOOK_LAST_MODIFICATION_DATE = GUEST_BOOK_ELEMENT_PREFIX + ":" + GUEST_BOOK_LAST_MODIFICATION_DATE_SUFFIX;
